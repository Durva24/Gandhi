...
"[project]/app/tax/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function TaxAssistant() {
    ...
    const [selectedIncome, setSelectedIncome] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(new Set());
    const [selectedExpenses, setSelectedExpenses] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(new Set());
    ...
    const [taxReport, setTaxReport] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TaxAssistant.useEffect": ()=>{
            fetchData();
        }
    }["TaxAssistant.useEffect"], []);
    const fetchData = async ()=>{
        try {
            const res = await fetch('/api/chat/context.ts');
    ...
    const downloadPDF = ()=>{
        ...
        setTimeout(()=>{
            ...
            doc.text(`₹${(data.income.monthly_salary * 12).toLocaleString('en-IN')}`, 160, 68, {
                align: 'right'
            });
            doc.text(`Freelance Income (Annual)`, 20, 76);
            doc.text(`₹56,050`, 160, 76, {
                align: 'right'
            });
            doc.setFont(undefined, 'bold');
            doc.text(`Total Gross Income`, 20, 86);
            doc.text(`₹${taxReport.totalIncome.toLocaleString('en-IN')}`, 160, 86, {
                align: 'right'
            });
            doc.setFont(undefined, 'bold');
            ...
            doc.text(`₹${taxReport.standardDeduction.toLocaleString('en-IN')}`, 160, 113, {
                align: 'right'
            });
            doc.text(`Section 80C (PPF, ELSS, Insurance)`, 20, 121);
            doc.text(`₹${taxReport.section80C.toLocaleString('en-IN')}`, 160, 121, {
                align: 'right'
            });
            doc.setFont(undefined, 'bold');
            doc.text(`Total Deductions`, 20, 131);
            doc.text(`₹${(taxReport.standardDeduction + taxReport.section80C).toLocaleString('en-IN')}`, 160, 131, {
                align: 'right'
            });
            doc.setFillColor(196, 240, 0);
            ...
            doc.text(`₹${taxReport.taxableIncome.toLocaleString('en-IN')}`, 160, 148, {
                align: 'right'
            });
            doc.setFontSize(10);
            doc.setFont(undefined, 'bold');
            ...
            doc.text(`₹${Math.round(taxReport.tax).toLocaleString('en-IN')}`, 160, 178, {
                align: 'right'
            });
            doc.text(`Health & Education Cess (4%)`, 20, 186);
            doc.text(`₹${Math.round(taxReport.cess).toLocaleString('en-IN')}`, 160, 186, {
                align: 'right'
            });
            ...
            doc.text(`₹${Math.round(taxReport.totalTax).toLocaleString('en-IN')}`, 160, 203, {
                align: 'right'
            });
            doc.setTextColor(5, 5, 5);
            doc.setFontSize(10);
            ...
            const recommendations = [
                '• Maximize 80C deductions - Currently using ₹1,50,000',
                '• Consider 80D for health insurance premium (up to ₹25,000)',
                '• Explore NPS for additional ₹50,000 deduction under 80CCD(1B)',
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    taxReport && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        onClick: downloadPDF,
                        disabled: generating,
                        style: {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                children: [
                                                                    ...
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                        ...
                                                                        children: "Up to ₹1.5 lakh deduction"
                                                                    }, void 0, false, {
                                                                        fileName: "[project]/app/tax/page.tsx",
                                                                        lineNumber: 421,
                                                                        columnNumber: 23
                    ...
                    taxReport && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        style: {
                            background: '#ffffff',
                            border: '2px solid #050505',
                            padding: '20px',
...
_s(TaxAssistant, "MP38C0huNzR/lqyQiz7EZerBnMk=");
_c = TaxAssistant;
var _c;
__turbopack_context__.k.register(_c, "TaxAssistant");
...
//# sourceMappingURL=_10815ce2._.js.map