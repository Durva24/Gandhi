...
"[project]/app/api/get/lendings/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const { data, error } = await supabase.from('lendings').select('*').eq('user_id', userId).order('created_at', {
            ascending: false
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c8990b69._.js.map