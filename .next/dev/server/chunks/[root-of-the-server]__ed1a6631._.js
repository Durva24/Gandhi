...
"[project]/app/api/get/bills/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        let query = supabase.from('bills').select('*, accounts(account_name)').eq('user_id', userId);
        if (billId) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ed1a6631._.js.map