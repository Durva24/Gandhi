...
"[project]/app/api/price-search/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    ...
    if (!API_TOKEN) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: false,
            error: 'API key not configured. Check your .env.local file and restart the server.'
        }, {
            status: 500
        });
    }
    try {
        ...
        if (!createData.job_id) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                error: createData.reason || 'Failed to create job'
            }, {
                status: 400
            });
        }
        ...
        while(jobStatus !== 'finished' && attempts < maxAttempts){
            ...
            const statusResponse = await fetch(`https://api.priceapi.com/jobs/${jobId}?token=${API_TOKEN}`);
        ...
        // Step 3: Get results
        const resultsResponse = await fetch(`https://api.priceapi.com/products/bulk/${jobId}?token=${API_TOKEN}`);
        ...
        if (!product.success) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                error: product.reason || 'Product not found'
            }, {
                status: 404
            });
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e4b45a1d._.js.map