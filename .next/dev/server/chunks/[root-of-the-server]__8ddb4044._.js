...
async function POST(req) {
    try {
        ...
        // Build messages array for Groq API with JSON mode instruction
        const systemPrompt = `You are a helpful AI assistant focused on financial wisdom inspired by Gandhi's principles of simplicity and mindful spending. Current conversation context: ${chatContext}

You must respond in JSON format with exactly this structure:
{
  "response": "your helpful response to the user",
  "context": "a brief 1-2 sentence summary of what this conversation is about"
}

Provide a helpful response and update the context based on the conversation.`;
        const apiMessages = [
            {
                role: 'system',
        ...
        // Get AI response and context in one call using JSON mode
