...
"[project]/app/api/get/transactions/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        let query = supabase.from('transactions').select('*, accounts(account_name), categories(name)').eq('user_id', userId);
        if (transactionId) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__358f5444._.js.map